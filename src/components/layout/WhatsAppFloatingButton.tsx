...
export function WhatsAppFloatingButton() {
  ...
  return (
    <Reveal
      ...
      className="fixed bottom-6 right-6 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-gold text-ink-950 shadow-gold hover:scale-105 active:scale-95"
    >
